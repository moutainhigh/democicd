...
public interface RoleService extends BaseService {
    ...
    * 保存一条 Role 数据
    *
    * @param roleDTO 待保存的数据
    * @param request
    * @throws BizException 保存失败异常
    */
    void saveRole(RoleDTO roleDTO, HttpServletRequest request) throws BizException;

    /**
     * 保存多条 Role 数据
     *
     * @param roleList 待保存的数据列表
     * @throws BizException 保存失败异常
     */
    void saveRoleList(List<Role> roleList) throws BizException;

    /**
     * 修改一条 Role 数据
     *
     * @param id 数据唯一id
     * @param roleDTO 待修改的数据
     * @param request
     * @throws BizException 修改失败异常
     */
    void updateRole(Long id, RoleDTO roleDTO, HttpServletRequest request) throws BizException;
     ...
     */
    void updateRoleSelective(Map<String, Object> dataMap, Map<String, Object> conditionMap);
     ...
     */
    void logicDeleteRole(Long id, HttpServletRequest request) throws BizException;
     ...
     */
    void deleteRole(Long id) throws BizException;
     ...
     * @return 符合条件的一个 role
     */
    RoleDTO findOneRole(Map<String, Object> params);
     ...
     * @throws BizException
     */
    void updateRoleAndRoleAction(Long id, RoleDTO roleDTO, HttpServletRequest request) throws BizException;
