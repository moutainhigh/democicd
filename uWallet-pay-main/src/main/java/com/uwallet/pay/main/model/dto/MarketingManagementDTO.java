...
public class MarketingManagementDTO extends BaseDTO implements Serializable {
     ...
     * 格式化过期时间字符串
     */
    @ApiModelProperty(value = "格式化过期时间字符串")
    @Transient
     ...
     * 邀请码有效期选择值
     */
    @ApiModelProperty(value = "邀请码有效期选择值")
    @Transient
    private Integer validitySelectValue;
