...
public interface ContentService extends BaseService {
    ...
    * 保存一条 Content 数据
    *
    * @param contentDTO 待保存的数据
    * @param request
    * @throws BizException 保存失败异常
    */
    void saveContent(ContentDTO contentDTO, HttpServletRequest request) throws BizException;

    /**
     * 保存多条 Content 数据
     *
     * @param contentList 待保存的数据列表
     * @param request
     * @throws BizException 保存失败异常
     */
    void saveContentList(List<Content> contentList, HttpServletRequest request) throws BizException;

    /**
     * 修改一条 Content 数据
     *
     * @param id 数据唯一id
     * @param contentDTO 待修改的数据
     * @param request
     * @throws BizException 修改失败异常
     */
    void updateContent(Long id, ContentDTO contentDTO, HttpServletRequest request) throws BizException;
     ...
     */
    void updateContentSelective(Map<String, Object> dataMap, Map<String, Object> conditionMap);
     ...
     */
    void logicDeleteContent(Long id, HttpServletRequest request) throws BizException;
     ...
     */
    void deleteContent(Long id, HttpServletRequest request) throws BizException;

    /**
     * 根据id查询一条 Content
     *
     * @param id 数据唯一id
     * @return 查询到的 Content 数据
     */
     ...
     *
     * @param params 查询条件
     * @return 符合条件的一个 content
     */
    ContentDTO findOneContent(Map<String, Object> params);
     ...
     * @return 查询结果的数据集合
     */
    List<ContentDTO> find(Map<String, Object> params, Vector<SortingContext> scs, PagingContext pc);
