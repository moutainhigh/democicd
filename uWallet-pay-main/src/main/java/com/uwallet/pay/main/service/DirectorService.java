...
public interface DirectorService extends BaseService {
    ...
    * 保存一条 Director 数据
    *
    * @param directorDTO 待保存的数据
    * @param request
    * @throws BizException 保存失败异常
    */
    void saveDirector(DirectorDTO directorDTO, HttpServletRequest request) throws BizException;

    /**
     * 保存多条 Director 数据
     *
     * @param directorList 待保存的数据列表
     * @param request
     * @throws BizException 保存失败异常
     */
    void saveDirectorList(List<Director> directorList, HttpServletRequest request) throws BizException;

    /**
     * 修改一条 Director 数据
     *
     * @param id 数据唯一id
     * @param directorDTO 待修改的数据
     * @param request
     * @throws BizException 修改失败异常
     */
    void updateDirector(Long id, DirectorDTO directorDTO, HttpServletRequest request) throws BizException;
     ...
     */
    void updateDirectorSelective(Map<String, Object> dataMap, Map<String, Object> conditionMap);
     ...
     */
    void logicDeleteDirector(Long id, HttpServletRequest request) throws BizException;
     ...
     */
    void deleteDirector(Long id, HttpServletRequest request) throws BizException;

    /**
     * 根据id查询一条 Director
     *
     * @param id 数据唯一id
     * @return 查询到的 Director 数据
     */
    DirectorDTO findDirectorById(Long id);

    /**
     * 根据条件查询得到第一条 director
     *
     * @param params 查询条件
     * @return 符合条件的一个 director
     */
    DirectorDTO findOneDirector(Map<String, Object> params);
     ...
     * @return 查询结果的数据集合
     */
    List<DirectorDTO> find(Map<String, Object> params, Vector<SortingContext> scs, PagingContext pc);
     ...
     * @param merchantId
     */
    void deleteDirectorByMerchantId(Long merchantId);
