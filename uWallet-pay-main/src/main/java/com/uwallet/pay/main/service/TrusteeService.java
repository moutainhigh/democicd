 ...
 * @modified: baixinyue
 */
public interface TrusteeService extends BaseService {

   /**
    * 保存一条 Trustee 数据
    *
    * @param trusteeDTO 待保存的数据
    * @param request
    * @throws BizException 保存失败异常
    */
    void saveTrustee(TrusteeDTO trusteeDTO, HttpServletRequest request) throws BizException;

    /**
     * 保存多条 Trustee 数据
     *
     * @param trusteeList 待保存的数据列表
     * @param request
     * @throws BizException 保存失败异常
     */
    void saveTrusteeList(List<Trustee> trusteeList, HttpServletRequest request) throws BizException;

    /**
     * 修改一条 Trustee 数据
     *
     * @param id 数据唯一id
     * @param trusteeDTO 待修改的数据
     * @param request
     * @throws BizException 修改失败异常
     */
    void updateTrustee(Long id, TrusteeDTO trusteeDTO, HttpServletRequest request) throws BizException;
     ...
     */
    void updateTrusteeSelective(Map<String, Object> dataMap, Map<String, Object> conditionMap);
     ...
     */
    void logicDeleteTrustee(Long id, HttpServletRequest request) throws BizException;
     ...
     */
    void deleteTrustee(Long id, HttpServletRequest request) throws BizException;

    /**
     * 根据id查询一条 Trustee
     *
     * @param id 数据唯一id
     * @return 查询到的 Trustee 数据
     */
    TrusteeDTO findTrusteeById(Long id);

    /**
     * 根据条件查询得到第一条 trustee
     *
     * @param params 查询条件
     * @return 符合条件的一个 trustee
     */
    TrusteeDTO findOneTrustee(Map<String, Object> params);
     ...
     * @return 查询结果的数据集合
     */
    List<TrusteeDTO> find(Map<String, Object> params, Vector<SortingContext> scs, PagingContext pc);
     ...
     * @param merchantId
     */
    void deleteTrusteeByMerchantId(Long merchantId);
