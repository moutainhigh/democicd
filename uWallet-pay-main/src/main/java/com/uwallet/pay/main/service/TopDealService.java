 ...
 * @modified: zhoutt
 */
public interface TopDealService extends BaseService {

   /**
    * 保存一条 TopDeal 数据
    *
    * @param topDealDTO 待保存的数据
    * @param request
    * @throws BizException 保存失败异常
    */
    void saveTopDeal(TopDealDTO topDealDTO, HttpServletRequest request) throws BizException;

    /**
     * 保存多条 TopDeal 数据
     *
     * @param topDealList 待保存的数据列表
     * @param request
     * @throws BizException 保存失败异常
     */
    void saveTopDealList(List<TopDeal> topDealList, HttpServletRequest request) throws BizException;

    /**
     * 修改一条 TopDeal 数据
     *
     * @param id 数据唯一id
     * @param topDealDTO 待修改的数据
     * @param request
     * @throws BizException 修改失败异常
     */
    void updateTopDeal(Long id, TopDealDTO topDealDTO, HttpServletRequest request) throws BizException;
     ...
     */
    void updateTopDealSelective(Map<String, Object> dataMap, Map<String, Object> conditionMap);
     ...
     */
    void logicDeleteTopDeal(Long id, HttpServletRequest request) throws BizException;
     ...
     */
    void deleteTopDeal(Long id, HttpServletRequest request) throws BizException;

    /**
     * 根据id查询一条 TopDeal
     *
     * @param id 数据唯一id
     * @return 查询到的 TopDeal 数据
     */
    TopDealDTO findTopDealById(Long id);

    /**
     * 根据条件查询得到第一条 topDeal
     *
     * @param params 查询条件
     * @return 符合条件的一个 topDeal
     */
    TopDealDTO findOneTopDeal(Map<String, Object> params);
     ...
     * @return 查询结果的数据集合
     */
    List<TopDealDTO> find(Map<String, Object> params, Vector<SortingContext> scs, PagingContext pc);
