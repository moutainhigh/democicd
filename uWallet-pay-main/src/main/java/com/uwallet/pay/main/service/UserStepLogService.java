 ...
 * @modified: baixinyue
 */
public interface UserStepLogService extends BaseService {

   /**
    * 保存一条 UserStepLog 数据
    *
    * @param userStepLogDTO 待保存的数据
    * @param request
    * @throws BizException 保存失败异常
    */
    void saveUserStepLog(UserStepLogDTO userStepLogDTO, HttpServletRequest request) throws BizException;

    /**
     * 保存多条 UserStepLog 数据
     *
     * @param userStepLogList 待保存的数据列表
     * @param request
     * @throws BizException 保存失败异常
     */
    void saveUserStepLogList(List<UserStepLog> userStepLogList, HttpServletRequest request) throws BizException;

    /**
     * 修改一条 UserStepLog 数据
     *
     * @param id 数据唯一id
     * @param userStepLogDTO 待修改的数据
     * @param request
     * @throws BizException 修改失败异常
     */
    void updateUserStepLog(Long id, UserStepLogDTO userStepLogDTO, HttpServletRequest request) throws BizException;

    /**
     * 根据Id部分更新实体 userStepLog
     *
     * @param dataMap 需要更新的键值对
     * @param conditionMap where语句后的条件筛选的键值对
     */
    void updateUserStepLogSelective(Map<String, Object> dataMap, Map<String, Object> conditionMap);

    /**
     * 根据id逻辑删除一条 UserStepLog
     *
     * @param id 数据唯一id
     * @param request
     * @throws BizException 逻辑删除异常
     */
    void logicDeleteUserStepLog(Long id, HttpServletRequest request) throws BizException;

    /**
     * 根据id物理删除一条 UserStepLog
     *
     * @param id 数据唯一id
     * @param request
     * @throws BizException 物理删除异常
     */
    void deleteUserStepLog(Long id, HttpServletRequest request) throws BizException;

    /**
     * 根据id查询一条 UserStepLog
     *
     * @param id 数据唯一id
     * @return 查询到的 UserStepLog 数据
     */
    UserStepLogDTO findUserStepLogById(Long id);

    /**
     * 根据条件查询得到第一条 userStepLog
     *
     * @param params 查询条件
     * @return 符合条件的一个 userStepLog
     */
    UserStepLogDTO findOneUserStepLog(Map<String, Object> params);
     ...
     * @return 查询结果的数据集合
     */
    List<UserStepLogDTO> find(Map<String, Object> params, Vector<SortingContext> scs, PagingContext pc);
    ...
    * @return
    */
   JSONObject findStepLogNew(Map<String, Object> params, HttpServletRequest request) throws BizException;
