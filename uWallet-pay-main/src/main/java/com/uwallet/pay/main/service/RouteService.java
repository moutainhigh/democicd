...
public interface RouteService extends BaseService {
    ...
    * 保存一条 Route 数据
    *
    * @param routeDTO 待保存的数据
    * @param request
    * @throws BizException 保存失败异常
    */
    void saveRoute(RouteDTO routeDTO, HttpServletRequest request) throws BizException;

    /**
     * 保存多条 Route 数据
     *
     * @param routeList 待保存的数据列表
     * @param request
     * @throws BizException 保存失败异常
     */
    void saveRouteList(List<Route> routeList, HttpServletRequest request) throws BizException;

    /**
     * 修改一条 Route 数据
     *
     * @param id 数据唯一id
     * @param routeDTO 待修改的数据
     * @param request
     * @throws BizException 修改失败异常
     */
    void updateRoute(Long id, RouteDTO routeDTO, HttpServletRequest request) throws BizException;
     ...
     */
    void updateRouteSelective(Map<String, Object> dataMap, Map<String, Object> conditionMap);
     ...
     */
    void logicDeleteRoute(Long id, HttpServletRequest request) throws BizException;
     ...
     */
    void deleteRoute(Long id, HttpServletRequest request) throws BizException;

    /**
     * 根据id查询一条 Route
     *
     * @param id 数据唯一id
     * @return 查询到的 Route 数据
     */
     ...
     *
     * @param params 查询条件
     * @return 符合条件的一个 route
     */
    RouteDTO findOneRoute(Map<String, Object> params);
     ...
     * @return 查询结果的数据集合
     */
    List<RouteDTO> find(Map<String, Object> params, Vector<SortingContext> scs, PagingContext pc);
     ...
     * @return 查询结果的数据集合
     */
    List<RouteDTO> findList(Map<String, Object> params, Vector<SortingContext> scs, PagingContext pc);
     ...
     * @param merchantId
     */
    void deleteRouteByMerchantId(Long merchantId);
