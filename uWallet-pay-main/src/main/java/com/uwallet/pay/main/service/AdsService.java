...
public interface AdsService extends BaseService {
    ...
    */
    void saveAds(AdsDTO adsDTO, HttpServletRequest request) throws BizException;

    /**
     * 保存多条 Ads 数据
     *
     * @param adsList 待保存的数据列表
     * @param request
     * @throws BizException 保存失败异常
     */
    void saveAdsList(List<Ads> adsList, HttpServletRequest request) throws BizException;
     ...
     */
    void updateAds(Long id, AdsDTO adsDTO, HttpServletRequest request) throws BizException;
     ...
     */
    void updateAdsSelective(Map<String, Object> dataMap, Map<String, Object> conditionMap);
     ...
     */
    void logicDeleteAds(Long id, HttpServletRequest request) throws BizException;
     ...
     */
    void deleteAds(Long id, HttpServletRequest request) throws BizException;
     ...
     * @return 符合条件的一个 ads
     */
    AdsDTO findOneAds(Map<String, Object> params);
     ...
     * @return 查询结果的数据集合
     */
    List<AdsDTO> find(Map<String, Object> params, Vector<SortingContext> scs, PagingContext pc);
