...
public interface TagService extends BaseService {
    ...
    */
    void saveTag(TagDTO tagDTO, HttpServletRequest request) throws BizException;

    /**
     * 保存多条 Tag 数据
     *
     * @param tagList 待保存的数据列表
     * @param request
     * @throws BizException 保存失败异常
     */
    void saveTagList(List<Tag> tagList, HttpServletRequest request) throws BizException;
     ...
     */
    void updateTag(Long id, TagDTO tagDTO, HttpServletRequest request) throws BizException;
     ...
     */
    void updateTagSelective(Map<String, Object> dataMap, Map<String, Object> conditionMap);
     ...
     */
    void logicDeleteTag(Long id, HttpServletRequest request) throws BizException;
     ...
     */
    void deleteTag(Long id, HttpServletRequest request) throws BizException;
     ...
     * @return 符合条件的一个 tag
     */
    TagDTO findOneTag(Map<String, Object> params);
     ...
     * @return 查询结果的数据集合
     */
    List<TagDTO> find(Map<String, Object> params, Vector<SortingContext> scs, PagingContext pc);
  ...
  * @return
  */
 Object getTagInfo(HttpServletRequest request);

 /**
  * 系统跑批更新redis top10 tag数据
  */
 void updateTop10Tags();
  ...
  * @param request
  */
 void updateTagPopular(String keyword, HttpServletRequest request);
  ...
  * @return
  */
 List<String> matchTags(JSONObject data, HttpServletRequest request);

 /**
  * 获取全量tag信息
  * @return
  */
 Object getTagAllInfo();
}
