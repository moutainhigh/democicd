 ...
 * </p>
 *
 * @description: 分期付excel文档实体类
 * @author: aarons
 * @date: Created in 2019-12-18 09:25:21
 */
@ApiModel("分期付excel文档实体类")
@Data
@ToString(callSuper = true)
@EqualsAndHashCode(callSuper = true)
@JsonIgnoreProperties(ignoreUnknown = true)
public class ExcelInstPayDTO extends BaseDTO implements Serializable {
    /*
    ...
    @ApiModelProperty(value = "customer_name ")
    ...
    //
    @ApiModelProperty(value = " ")
    private String cleared_term;
    //
    @ApiModelProperty(value = " ")
    private String cleared_amount;
