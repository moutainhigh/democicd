...
public class KycSubmitLogDTO extends BaseDTO implements Serializable {
    ...
    /**
     * kyc状态0,1 Accept, 2: reject, 3 DataSource not available 4system error 5 kyc error
     */
    @ApiModelProperty(value = "kyc状态0,1 Accept, 2: reject, 3 DataSource not available 4system error 5 kyc error")
