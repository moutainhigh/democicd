 ...
 * @modified: zhoutt
 */
public interface MailLogService extends BaseService {

   /**
    * 保存一条 MailLog 数据
    *
    * @param mailLogDTO 待保存的数据
    * @param request
    * @throws BizException 保存失败异常
    */
    void saveMailLog(MailLogDTO mailLogDTO, HttpServletRequest request) throws BizException;

    /**
     * 保存多条 MailLog 数据
     *
     * @param mailLogList 待保存的数据列表
     * @param request
     * @throws BizException 保存失败异常
     */
    void saveMailLogList(List<MailLog> mailLogList, HttpServletRequest request) throws BizException;

    /**
     * 修改一条 MailLog 数据
     *
     * @param id 数据唯一id
     * @param mailLogDTO 待修改的数据
     * @param request
     * @throws BizException 修改失败异常
     */
    void updateMailLog(Long id, MailLogDTO mailLogDTO, HttpServletRequest request) throws BizException;
     ...
     */
    void updateMailLogSelective(Map<String, Object> dataMap, Map<String, Object> conditionMap);
     ...
     */
    void logicDeleteMailLog(Long id, HttpServletRequest request) throws BizException;
     ...
     */
    void deleteMailLog(Long id, HttpServletRequest request) throws BizException;

    /**
     * 根据id查询一条 MailLog
     *
     * @param id 数据唯一id
     * @return 查询到的 MailLog 数据
     */
    MailLogDTO findMailLogById(Long id);

    /**
     * 根据条件查询得到第一条 mailLog
     *
     * @param params 查询条件
     * @return 符合条件的一个 mailLog
     */
    MailLogDTO findOneMailLog(Map<String, Object> params);
     ...
     * @return 查询结果的数据集合
     */
    List<MailLogDTO> find(Map<String, Object> params, Vector<SortingContext> scs, PagingContext pc);
