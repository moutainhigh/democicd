 ...
 */
public interface PosInfoService extends BaseService {

    /**
     * 保存一条 PosInfo 数据
     *
     * @param posInfoDTO 待保存的数据
     * @param request
     * @throws BizException 保存失败异常
     */
    void savePosInfo(PosInfoDTO posInfoDTO, HttpServletRequest request) throws BizException;

    /**
     * 保存多条 PosInfo 数据
     *
     * @param posInfoList 待保存的数据列表
     * @param request
     * @throws BizException 保存失败异常
     */
    void savePosInfoList(List<PosInfo> posInfoList, HttpServletRequest request) throws BizException;

    /**
     * 修改一条 PosInfo 数据
     *
     * @param id         数据唯一id
     * @param posInfoDTO 待修改的数据
     * @param request
     * @throws BizException 修改失败异常
     */
    void updatePosInfo(Long id, PosInfoDTO posInfoDTO, HttpServletRequest request) throws BizException;
     ...
     */
    void updatePosInfoSelective(Map<String, Object> dataMap, Map<String, Object> conditionMap);
     ...
     */
    void logicDeletePosInfo(Long id, HttpServletRequest request) throws BizException;
     ...
     */
    void deletePosInfo(Long id, HttpServletRequest request) throws BizException;

    /**
     * 根据id查询一条 PosInfo
     *
     * @param id 数据唯一id
     * @return 查询到的 PosInfo 数据
     */
    PosInfoDTO findPosInfoById(Long id);

    /**
     * 根据条件查询得到第一条 posInfo
     *
     * @param params 查询条件
     * @return 符合条件的一个 posInfo
     */
    PosInfoDTO findOnePosInfo(Map<String, Object> params);
     ...
     * @return 查询结果的数据集合
     */
    List<PosInfoDTO> find(Map<String, Object> params, Vector<SortingContext> scs, PagingContext pc);
